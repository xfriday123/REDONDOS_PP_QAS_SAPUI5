sap.ui.define([
	...
	return Controller.extend("nsrdos.uiportalprov_qas.controller.Vista_Registro_Factura", {
		...
		onAfterRendering: function () {
			...
			// MAURO 20211014
            this.varTableURL4 = oModel.getProperty("/listTablasOData/clistTablasODataURL4"); //20220804
            this.varTableT_FAC_DET_INSERT = oModel.getProperty("/listTablasOData/clistTablasODataT_FAC_DET_INSERT"); //20220804
            this.varTableT_FAC_POS_INSERT = oModel.getProperty("/listTablasOData/clistTablasODataT_FAC_POS_INSERT"); //20220804
            this.varTableT_OC_DET_UPDATE = oModel.getProperty("/listTablasOData/clistTablasODataT_OC_DET_UPDATE"); //20220804
            ...
            while (this.oGlobalStop10 === "S") {
                $.ajax({
                    type: "GET",
                    async: false,
                    url: this.varTableURL + "/" + this.varTableT_OC_DET + "?$format=json&$skiptoken=" + this.oGlobalIteracion0 + "&$filter=US_RUC eq '" + varUsuario + "' and EM_RUC eq '" + this.varRucDeLaEmpresa + "' and DE_FLAC ne '" + "x" + "' and DE_FLAC ne '" + "X" + "' and DE_ANO eq '" + oModel9.getProperty("/oGlobalTipoFechaAnio01") + "'",
		...
		validarFacturaFechaEmisionDC: function (varFechaEmision) {
			...
			var varRespuesta = "";
			if (dateFormatted4 <= fechaUsu && fechaUsu <= this.funSumarDias(dateFormatted1, parseInt(varMatrizDiasHabiles[0].CAMPO1, 10))) {
				varRespuesta = "S";
			} else {
				varRespuesta = "N";
			}
		...
		btnFacturarMesage: function () {
            ...
            var varTotal = varTamListCabecera + 2 + varTamListDocumentos; //20220804
							...
							if (lenghtV === 0) {
                                ...
                                $.ajax(this.varTableURL + "/" + this.varTableT_FAC, {
                                    ...
                                    success: function (data) {
										...
										var llavePos = {};
                                        var oVectorPosTFACDET = []; //20220804
										var llaveItem = {};
                                        var oVectorPosTFACPOS = []; //20220804
										for (var a = 0; a < listItemDetalleFactura.length; a++) {
											llavePos = {};
                                            ...
                                            oVectorPosTFACDET.push(llavePos); //20220804
											var itemsOC = listItemDetalleFactura[a].clistItemsOrdenCompra;
                                            console.log(itemsOC);
											for (var b = 0; b < itemsOC.length; b++) {
												llaveItem = {};
                                                ...
                                                $.ajax(this.varTableURL + "/" + this.varTableT_FAC_POS, {
                                                    ...
                                                    success: function (data) {
                                                        ...
                                                        /*var oVectorJSON = JSON.stringify(llaveActualizar); //20220804
                                                        v//ar oHeaders = { 'X-CSRF-Token': this.token }
                                            ...
                                            /*var oVectorJSON = JSON.stringify(llavePos); //20220804
                                            var oHeaders = { 'X-CSRF-Token': this.token };
                                        ...
                                        // INSERT T_FAC_DET
                                        console.log(oVectorPosTFACDET);
                                        var oDataInsTFACDET = {
                                            "ID" : 1,
                                            "T_FAC_DET": oVectorPosTFACDET,
                                            "myResponse" : ""
                                        }
                                        console.log(oDataInsTFACDET);
                                        var oVectorJSON = JSON.stringify(oDataInsTFACDET); //20220804
                                        console.log(oVectorJSON);
                                        var oHeaders = { 'X-CSRF-Token': this.token };
                                        $.ajax(this.varTableURL4 + "/" + this.varTableT_FAC_DET_INSERT, {
                                            headers: oHeaders,
                                            data: oVectorJSON,
                                            type: "POST",
                                            contentType: "application/json",
                                        ...
                                        // INSERT T_FAC_POS
                                        console.log(oVectorPosTFACPOS);
                                        var oDataInsTFACPOS = {
                                            "ID" : 1,
                                            "T_FAC_POS": oVectorPosTFACPOS,
                                            "myResponse" : ""
                                        }
                                        console.log(oDataInsTFACPOS);
                                        var oVectorJSON2 = JSON.stringify(oDataInsTFACPOS); //20220804
                                        console.log(oVectorJSON2);
                                        var oHeaders = { 'X-CSRF-Token': this.token };
                                        $.ajax(this.varTableURL4 + "/" + this.varTableT_FAC_POS_INSERT, {
                                            headers: oHeaders,
                                            data: oVectorJSON2,
                                            type: "POST",
                                            contentType: "application/json",
                                            ...
                                            success: function (data) {
                                                console.log(data);
                                                var oDataNew = data.T_FAC_POS;
                                                var oModelJSONnew = new sap.ui.model.json.JSONModel(data.T_FAC_POS);
                                                console.log(oDataNew);
                                                console.log(oModelJSONnew);
                                                ...
                                                console.log(oModelJSONnew.getData());
                                                console.log(oModelJSONnew.getData().length);
                                                for (var i = 0; i < oModelJSONnew.getData().length; i++) {
                                                    oLlave = {};
                                                    oLlave.DE_HOJA_ENTRADA = oModelJSONnew.getData()[i].DE_HOJA_ENTRADA;
                                                    oLlave.DE_NUMERO_ORDEN = oModelJSONnew.getData()[i].OC_NUMERO_ORDEN;
                                                    oLlave.DE_POS_DOC_MATERIAL = oModelJSONnew.getData()[i].DE_POS_DOC_MATERIAL;
                                                    oLlave.DE_DOC_MATERIAL = oModelJSONnew.getData()[i].DE_DOC_MATERIAL;
                                                    oLlave.EM_RUC = oModelJSONnew.getData()[i].EM_RUC;
                                                    oLlave.US_RUC = oModelJSONnew.getData()[i].US_RUC;
                                                    oLlave.DE_POSICION = oModelJSONnew.getData()[i].DE_POSICION;
                                                    //oLlave.GUIA_REMISION = oModelJSONnew[i].GUIA_REMISION;
                                                    oLlave.DE_FLAC = "x";
                                                    oVector.push(oLlave);
                                                }
                                                console.log(oVector);
                                                ...
                                                console.log(oDataInsTOCDET);
                                                var oVectorJSON = JSON.stringify(oDataInsTOCDET); //20220804
                                                console.log(oVectorJSON);
                                                var oHeaders = { 'X-CSRF-Token': this.token };
                                                $.ajax(this.varTableURL4 + "/" + this.varTableT_OC_DET_UPDATE, {
                                                    headers: oHeaders,
                                                    data: oVectorJSON,
                                                    type: "POST",
                                                    contentType: "application/json",
