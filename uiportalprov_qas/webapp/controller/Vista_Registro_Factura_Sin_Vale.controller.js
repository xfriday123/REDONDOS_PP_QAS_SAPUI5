sap.ui.define([
	...
	return Controller.extend("nsrdos.uiportalprov_qas.controller.Vista_Registro_Factura_Sin_Vale", {
		...
		onAfterRendering: function () {
            ...
            $.ajax({
                type: "GET",
                url: this.varTableURL + "/" + this.varTableT_OC_DET + "?$format=json&$filter=US_RUC eq '" + varUsuario + "' and EM_RUC eq '" + this.varRucDeLaEmpresa + "' and DE_FLAC ne '" + "x" + "' and DE_FLAC ne '" + "X" + "' and DE_ANO eq '" + oModel.getProperty("/oGlobalTipoFechaAnio01") + "'",
