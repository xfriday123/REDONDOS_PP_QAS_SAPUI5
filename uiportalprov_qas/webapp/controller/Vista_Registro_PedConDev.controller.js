sap.ui.define([
	...
	return Controller.extend("nsrdos.uiportalprov_qas.controller.Vista_Registro_PedConDev", {
		...
		oDialogOrdenDeCompra: function(varPosicionFactura, varCodigoFactura, varValortotalNetoFactura, varDescripcionFactura,
			...
			var lista = new sap.m.List({
				...
				select: function(evt) {
					...
					$.ajax({
						type: "GET",
						url: this.varTableURL + "/" + this.varTableT_OC_DET + "?$format=json&$filter=DE_NUMERO_ORDEN eq '" + vlistOrdenCompraNum + "'",
						success: function(response) {
							try {
								var realizar = false;
								var realizar2 = false;
