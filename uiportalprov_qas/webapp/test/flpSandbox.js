		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#nsrdosuiportalprov_qas-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsrdosuiportalprov_qas-display": {
								"semanticObject": "nsrdosuiportalprov_qas",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nsrdos.uiportalprov_qas",
									"url": sap.ui.require.toUrl("nsrdos/uiportalprov_qas")
								}
							}
						}
					}
